...
namespace BusinessLayer
{
    public class Model : IModel
    {
        ...
        private List<IExtraCharge> _extraChargeList;
        ...
        public List<IExtraCharge> ExtraChargeList
        {
            get { return _extraChargeList; }
            set { _extraChargeList = value; }
        }
       ...
       public void updateOrderStatus(bool status)
        {
            _dataLayer.updateOrderStatus(status);
        }
        ...
        public void SetupMenu(string itemName, string itemType, double itemPrice, string itemDescrip)
        {
            _dataLayer.SetupMenu(itemName, itemType, itemPrice, itemDescrip);
        }
        ...
        //  send order to DB
        //
        public bool SendOrder(Dictionary<string, int> orderList, string tickenNum, double totalBalance)

        {
            var result = _dataLayer.Order(orderList, tickenNum, totalBalance);
...
public void PopulateBookingList()
        ...
        public void PopulateExtraChargeList()
        {
            _extraChargeList = _dataLayer.GetAllExtraCharges();
        }
        ...
        {
            var result =_dataLayer.UpdateEmployeeDetails(employee);
            if (result)
                return true;
            else
                return false;
