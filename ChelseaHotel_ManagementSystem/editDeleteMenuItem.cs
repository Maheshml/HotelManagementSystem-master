...
namespace ChelseaHotel_ManagementSystem
{
        ...
        { try {
                ...
                try
                {
                    ...
                    var wri = PdfWriter.GetInstance(doc,
                        new FileStream(
                            "C:\\HotelManagementSystem\\ChelseaHotel_ManagementSystem\\ChelseaHotel_ManagementSystem\\Resources\\Restaurant Menu\\" + fileName +num+".pdf",
                            FileMode.Create));
                ...
                {
                    MessageBox.Show("ERROR: Something went wrong when generating the Menu Document\n" + ex.Message);
                    return false;
                }
                ...
                finally
                {
                    ...
                    (iTextSharp.text.BadElementException ex)
                {
                    MessageBox.Show("ERROR: Something went wrong \nwhen generating the Menu Document\n" + ex.Message);
                    return false;
                }
    ...
    private static IDataLayer DataLayer;
        ...
        {
            var addItem = new SetUpMenu(fc, _model);
            this.Hide();
            addItem.Show();
        }
        ...
        private void Refresh_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(@"To be completed in phase two.");
